...
// . Include a comment documenting each warning and error you correct.
// . Format this source code into perfect K&R style.
// . Follow the coding guidlines we discussed in Wednesday's lecture.
//
//
...
int main(int argc, char **argv) {
	...
	// type casted the string constant to (char *)
	page = (char *)PAGE;
    }
    ...
    free(remote);
    free(ip);
    // Fixed warning: 'close' was not declared in this scope
    // // add include file named <unistd.h>
    close(sock);
    return 0;
}
...
char *build_get_query(char *host, char *page)
{
    ...
    char *getpage = page;
    // Fixed warning: deprecated conversion from string constant to char*
    // typed casted the string constant to a (char *)
